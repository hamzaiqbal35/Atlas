...
export default function LineSidebar({
  ...
  onItemClick,
  className = ''
}: LineSidebarProps & { activeItem?: number | null }) {
  ...
  // Use activeItem if provided, otherwise fallback to local state
  const isControlled = activeItem !== undefined && activeItem !== null;
  const [localActiveIndex, setLocalActiveIndex] = useState(defaultActive);
  const activeIndex = isControlled ? activeItem : localActiveIndex;
